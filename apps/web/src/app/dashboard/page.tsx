  ...
  return (
    <div>
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          { label: 'Buildings', value: '—', color: 'blue', icon: '🏢' },
          { label: 'Gateways', value: '—', color: 'green', icon: '📡' },
          { label: 'Detectors', value: '—', color: 'orange', icon: '🔎' },
          { label: 'Active Alarms', value: '0', color: 'red', icon: '🚨' },
        ].map((stat) => (
